...
void Object3d::StaticInit(ID3D12Device* device, Camera* camera)
{
	// 再初期化チェック
	assert(!Object3d::dev);
...
void Object3d::BeforeDraw(ID3D12GraphicsCommandList* cmdList)
{
...
void Object3d::PlayerUpdate(Quaternion pRotMatrix)
{
	assert(camera);
